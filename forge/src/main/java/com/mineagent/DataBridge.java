...
/**
 * Central bridge for data exchange between network handler and game events.
 * Manages the latest raw input, observations, and connection state.
 */
public class DataBridge {
    ...
    /**
     * Gets and clears the latest raw input.
     * Returns null if no new input is available.
     */
    ...
    /**
     * Sets whether a Python client is connected.
     * Used for input suppression.
     */
